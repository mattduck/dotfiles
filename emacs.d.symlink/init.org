  ...
  (defun md/set-default-font ()
    ...
    (cond ((s-starts-with-p "mattmbp" (system-name))
          ...
          ((s-starts-with-p "omattria" (system-name))
           (set-frame-font "Roboto Mono Light for Powerline-12:antialias=subpixel" t t))
          (t
           (set-frame-font "Roboto Mono Light for Powerline-14:antialias=subpixel" t t))))
#+END_SRC
...
- [ ] [2017-05-18 Thu] ansi-term - get C-r and my usual C-n/C-p bindings?
  - [2017-10-24 Tue 23:17] I think the ansi-term issues were fixed by the C-j inputrc issue.
