...
- [ ] [2017-03-17 Fri] binding to list all keys in a map using which-key.
  - which-key-show-keymap can probably do this, but it hides evil
    bindings under eg. a normal-state prefix, which not sure how to follow.
...
- [ ] [2017-03-18 Sat] how to handle C-o and C-i in org? As C-i does tab?
