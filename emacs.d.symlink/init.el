...
(defun md/org-list-utf-enable ()
  ;; TODO: use different pretty icons for each indent level?
  (interactive)
...
(defun md/alfred-source-system ()
  (helm-build-sync-source "System"
    :multimatch nil
    :requires-pattern nil
    :candidates '(("Lock" . "i3lock -c 282828")
...
(use-package elfeed
  ...
  (progn
    (setq elfeed-search-title-max-width 110
          elfeed-search-filter "@2-weeks-ago -hidden")
...
(bind-key "tW" 'md/wiki-reader md/leader-map)
