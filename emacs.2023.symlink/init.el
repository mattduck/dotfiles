...
(defun md/display-buffer-in-overlay (buffer _alist)
  "Display BUFFER using `show-buffer-popup` as an overlay instead of a window.
BUFFER is the buffer object to display."
  (md/do-display-buffer-in-overlay buffer)
...
(defun md/do-display-buffer-in-overlay (buffer)
  "Show the contents of BUFFER as an overlay popup."
